...
Somos uma equipe multidisciplinar de alunos do ensino médio apaixonados por tecnologia. Trabalhamos juntos para enfrentar os desafios da temporada FTC, aplicando conceitos de STEM com criatividade, dedicação e muito trabalho em equipe.

---

## 🧠 Nossos Valores

- 💡 **Inovação**: testamos novas ideias sempre.
- 🤝 **Colaboração**: juntos somos mais fortes.
- 🛠️ **Excelência Técnica**: buscamos qualidade em cada detalhe.
- 🔄 **Iteração Contínua**: errar, aprender, corrigir e evoluir.
- 🌍 **Impacto Social**: promovemos a robótica além da competição.

---

## Deseja nos conhecer melhor ou talvez até firmar uma parceria? Entre em contato conosco e acompanhe nosso trabaho em nossas redes sociais!
